    ...
    <div class="h-screen flex justify-center items-center ">
        <form method="POST" action="{{route("tasks.store")}}" class="bg-gray-100 p-6 w-96">
            ...
            <div class="flex flex-col space-y-2 mb-4">
                <label>Task :</label>
                <input type="text" placeholder="Create your task" name="title" class="p-2 bg-gray-50 shadow">
                @error('title')
            ...
            <div class="flex flex-col space-y-2 mb-4">
                <label>Status : </label>
                <select name="status" class="p-2 bg-gray-50 shadow">
            ...
            <div class="flex flex-col space-y-2 mb-4">
                ...
                <input type="date" name="due_date" class="p-2 bg-gray-50 shadow">
                @error('due_date')
                    <span class="text-red-500 mt-1">
                        {{$message}}
                    </span>
