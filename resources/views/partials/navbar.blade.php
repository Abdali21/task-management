    ...
    <div class="flex items-center space-x-8">
        ...
        @auth
            ...
            <span class="cursor-pointer flex items-center space-x-2 relative" id="profile">
                <svg class="w-6 h-6 text-white hover:text-gray-300 " fill="none" stroke="currentColor" stroke-width="2"
                    viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M5.121 17.804A8.967 8.967 0 0112 15a8.967 8.967 0 016.879 2.804M12 12a4 4 0 100-8 4 4 0 000 8z">
                    </path>
                </svg>
                <span class="hover:text-gray-300  cursor-pointer">My Profile</span>
            </span>
            <div id="popup"
        ...
        @guest
            ...
            <div class="flex items-center space-x-4">
                <a href="{{route('login.show')}}" class="px-4 py-2 bg-green-500 rounded-md hover:bg-green-600 transition">
                    Login
                </a>
